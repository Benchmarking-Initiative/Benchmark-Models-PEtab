...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_0">
    ...
    <ListOfCompartments>
      <Compartment key="Compartment_0" name="single cell" simulationType="fixed" dimensionality="3" addNoise="false">
        <MiriamAnnotation>
...
<rdf:Description rdf:about="#Metabolite_1">
    ...
    <ListOfModelValues>
      <ModelValue key="ModelValue_0" name="delta" simulationType="fixed" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
...
<rdf:Description rdf:about="#ModelParameterSet_0">
        ...
        <ModelParameterGroup cn="String=Initial Time" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model" value="0.90000000000000002" type="Model" simulationType="time"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Compartment Sizes" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[single cell]" value="1" type="Compartment" simulationType="fixed"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[single cell],Vector=Metabolites[GFP]" value="0" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[single cell],Vector=Metabolites[mRNA]" value="6.0221407599999985e+23" type="Species" simulationType="ode"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0.90000000000000002 0 6.0221407599999985e+23 1 0.80000000000000004 0.029999999999999999 502 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_12" name="Time-Course" type="timeCourse" scheduled="false" updateModel="false">
      ...
      <Problem>
        ...
        <Parameter name="StepSize" type="float" value="0.025000000000000001"/>
  ...
  <ListOfPlots>
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        <PlotItem name="[GFP]" type="Curve2D">
          ...
          <ListOfChannels>
            ...
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[single cell],Vector=Metabolites[GFP],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[mRNA]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[single cell],Vector=Metabolites[mRNA],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
    </PlotSpecification>
